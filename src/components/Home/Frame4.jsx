  ...
  return (
    <div className="flex flex-col md:flex-row lg:flex-row items-center py-12 ">
      ...
      <div className="w-full md:w-1/2 px-4  mt-8 md:mt-0">
        <p className="text-5xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-[#FDE3AD] via-[#FAB735] to-[#FAA811] text-transparent bg-clip-text">Insights</p>
        ...
        <button className="bg-gradient-to-r from-[#FDE3AD] to-[#FAA811] rounded-full px-6 py-3 font-bold text-gray-900 transition duration-300 ease-in-out transform hover:scale-105">Learn more</button> 
      </div>
    </div>
  )
}
