...
const Frame4 = () => {
  return (
    ...
    <div className="w-1/2 px-12">
      <p className="text-8xl h-28 font-bold bg-gradient-to-r from-[#FDE3AD] via-[#FAB735] to-[#FAA811] inline-block text-transparent bg-clip-text">Insights</p>
      <p className="text-white text-lg text-justify py-8">
