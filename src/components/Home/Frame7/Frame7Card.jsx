...
const Frame7Card = ({ img, desc, title, isActive }) => {
  return (
    <div className="frame7-card text-white bg-[#271B3F] border-[1px] shadow-lg flex flex-col justify-center items-center py-12 md:py-28 lg:py-28 px-4 md:px-16 lg:px-16">
