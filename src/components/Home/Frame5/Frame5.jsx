...
const Frame5 = () => {
  ...
  return (
    ...
    >
      <p
        ref={topRef}
        className={`text-center text-4xl md:text-8xl lg:text-6xl font-bold bg-gradient-to-r from-[#FDE3AD] via-[#FAB735] to-[#FAA811] inline-block text-transparent bg-clip-text pt-6 ${
