...
const Frame1 = () => {
  ...
  return (
    <div className="fram1-bg px-6 md:px-12 min-h-screen">
      <Navbar/>
      <div className='flex flex-col md:flex-row items-center border-l-[2px] border-r-[2.5px] border-[#393555] px-6 md:px-12'>
        <div
