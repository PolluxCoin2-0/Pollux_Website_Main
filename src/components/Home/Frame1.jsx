  ...
  return (
    <div className="flex flex-col md:flex-row lg:flex-row items-center">
      <div className="w-1/2">
        ...
        <p className="text-8xl text-white font-bold bg-gradient-to-r from-[#FDE3AD] to-[#FAA811] inline-block text-transparent bg-clip-text">THE WEB</p>
        ...
        <button className="bg-gradient-to-r from-[#FDE3AD] to-[#FAA811] rounded-3xl px-4 py-3 font-bold">Learn more</button> 
      </div>
