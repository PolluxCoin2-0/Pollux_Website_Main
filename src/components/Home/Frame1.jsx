    ...
    <div className="fram1-bg px-6 md:px-6 lg:px-6 xl:px-6 2xl:px-12 min-h-screen pb-32 md:pb-0 lg:pb-0 xl:pb-0 2xl:pb-0">
      ...
      md:border-l-[2px] lg:border-l-[2px] md:border-r-[2.5px] lg:border-r-[2.5px] border-[#393555]'>
        <div
          ...
          ref={leftRef}
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-8xl text-white font-bold tracking-wide">DECENTRALIZE</h1>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-[#FDE3AD] via-[#FAB735] to-[#FAA811] inline-block text-transparent bg-clip-text">THE WEB</h1>
