...
const Frame3 = () => {
  ...
  return (
    ...
    style={{backgroundImage: `url(${BG})`,}}>
      <p className="text-4xl md:text-8xl lg:text-[5rem] md:h-28 lg:h-28 font-bold bg-gradient-to-r from-[#FDE3AD] via-[#FAB735] to-[#FAA811] inline-block text-transparent bg-clip-text">
